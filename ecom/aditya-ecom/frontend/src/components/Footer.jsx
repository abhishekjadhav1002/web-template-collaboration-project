  ...
  return (
    <footer className=" bg-PrimaryColor text-ExtraDarkColor rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div>
          <h1 className="font-semibold text-3xl pb-4"> WebShop</h1>
      ...
      <div>
        <p className="text-center text-xs sm:text-xl py-4">
          @copyright developed by
          <span className=" text-black"> Aditya Deshmukh</span> | All rights
          reserved
        </p>
      </div>
    </footer>
